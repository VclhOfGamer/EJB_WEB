...
<script type="text/javascript">
    ...
    function OpenBootstrapPopup() {
        $("#restocksuccessModal").modal('show');
    }
</script>

<!-- Modal -->
<div class="modal fade" id="restocksuccessModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div style="background-color:#03CC9D;" class="modal-header">
                <h5 class="modal-title text-light" id="exampleModalLabel">Restock Success</h5>
