...
<jsp:include page="../StaffView/staffincludes/cardbg.jsp" />
<title>Product</title>
...
<section class="animate__animated animate__fadeIn">
    <h2>Product</h2>
    <hr>
    <a href="StaffAddProduct" class="btn btn-primary" role="button">+ Add Product</a>
    <br><br>
    ...
    <div class="table-responsive">
        <table id="productTable" class="table table-sm table-striped table-hover text-center table-list" style="font-size:15px; width:100%">
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-primary" href="StaffEditProduct?id=<%= p.getId() %>"><i class="fas fa-edit"></i></a>
                    <a class="btn btn-sm btn-danger" href="StaffDeleteProduct?id=<%= p.getId() %>"><i class="fas fa-trash-alt"></i></a>
                </td>
            </tr>
            <% } %>
            </tbody>
    ...
    <style>
        ...
        /* Add these styles to match the admin page */
        .bg-c-green {
