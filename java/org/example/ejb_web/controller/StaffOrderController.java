...
@WebServlet(name = "StaffOrder", urlPatterns = {"/StaffOrder", "/StaffViewOrder"})
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            if ("/StaffOrder".equals(path)) {
                ...
                req.getRequestDispatcher("/WEB-INF/StaffView/StaffOrder.jsp").forward(req, resp);
            }

            else if ("/StaffViewOrder".equals(path)) {
                ...
                if ("deleteProduct".equals(action)) {
                    ...
                    resp.sendRedirect("StaffViewOrder?orderid=" + orderId);
                    return;
                }

                if ("StaffConfirmOrder".equals(action) && orderIdParam != null) {
                ...
                if (orderIdParam != null) {
                    ...
                    if (action != null && !" StaffConfirmOrder".equals(action)) {
                    ...
                    req.getRequestDispatcher("/WEB-INF/StaffView/viewStaffOrder.jsp").forward(req, resp);
                } else {
                    resp.sendRedirect("StaffOrder");
                }
            }
        ...
        try {
            ...
            switch (action) {
                case "StaffAddOrder": {
                    ...
                    if (staff == null) {
                        req.setAttribute("error", "Staff not found with ID: " + staffId);
                        req.getRequestDispatcher("error.jsp").forward(req, resp);
                        return;
                    }
                ...
                case "StaffAddProduct": {
                    ...
                    if ("DELIVER".equals(order.getOrderType()) && quantity > product.getQuantity()) {
                        // Not enough stock
                        resp.sendRedirect("StaffViewOrder?orderid=" + orderId + "&error=insufficient_stock");
                        return;
                    }
                ...
                case "StaffConfirmOrder": {
                    ...
                    if (order != null) {
                        ...
                        if (orderItems == null || orderItems.isEmpty()) {
                            ...
                            resp.sendRedirect("StaffViewOrder?orderid=" + orderId + "&error=empty_order");
                            return;
                        }
